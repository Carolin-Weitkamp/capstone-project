export default function Impressum() {
  return (
    <div>
      <h1>Impressum</h1>
      <p>
        Verantwortlich gemäß § 5 Telemediengesetz (TMG): Carolin Weitkamp
        Puterkamp 22 38165 Essenrode E-Mail: c.weitkamp[at]posteo.de Haftung für
        Inhalte Als Diensteanbieterin bin ich gemäß § 7 Abs.1 TMG für eigene
        Inhalte auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich.
        Nach §§ 8 bis 10 TMG bin ich als Diensteanbieterin jedoch nicht
        ...
        entfernen. Haftung für Links Mein Angebot enthält Links zu externen
        Websites Dritter, auf deren Inhalte ich keinen Einfluss habe. Deshalb
        kann ich für diese fremden Inhalte auch keine Gewähr übernehmen. Für die
        Inhalte der verlinkten Seiten ist stets der:die jeweilige Anbieter:in
        oder Betreiber:in der Seiten verantwortlich. Die verlinkten Seiten
        ...
        derartige Links umgehend entfernen. Urheberrecht Die erstellten Inhalte
        ...
        Zustimmung des Erstellers. Downloads und Kopien dieser Seite sind nur
